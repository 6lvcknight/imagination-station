        ...
        <group name="Sketchfab_model" rotation={[-Math.PI / 2, 0, 0]}>
          <group name="e5bd376021cc4d0db8c4771a7e886884fbx" rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
            <group name="Object_2">
              <group name="RootNode">
                <group name="Object_4">
                  {/* <group name="thundersphere" position={[13.3, 0, -11.88]} scale={4.19}>
                    <mesh name="thundersphere_THUNDERSPHERE_0" geometry={nodes.thundersphere_THUNDERSPHERE_0.geometry} material={materials.THUNDERSPHERE} />
                  </group> */}
                  <primitive object={nodes._rootJoint} />
                  {/* <group name="darksphere" position={[13.3, 0, -11.88]} scale={4.04}>
                    <mesh name="darksphere_BLACKSPHERE_0" geometry={nodes.darksphere_BLACKSPHERE_0.geometry} material={materials.BLACKSPHERE} />
                  </group> */}
